...
<script>
  var myMethods = {
    //播放视频
    loadVideoPlay(vediodataObj, isPlayVideoObj,isSetFullscreen,fileId) {
      console.log(vediodataObj)
      let that=this;
        ...
        jwplayer("video_dialog_show").setup({
          ...
          events: {
            ...
            onError: function (obj) {
              ...
              // that.$emit('getResource',fileId)
              console.log(vediodataObj)
              that.$emit('getResource','video')
            },
  ...
  export default {
    ...
    data() {
      return {
        videoData: [
          {
            file: "v1/a3495fb7-9951-47bc-acab-3730326e8718/48562f3a-8e6d-4baf-ba31-5930ad423e78.mp4",
            default: false
          },
        ],
