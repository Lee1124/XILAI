    ...
    */
    ...
    Galleria = function () {
        ...
        var lightbox = this._lightbox = {
            ...
            show: function (index) {
              window.Vue.getimageAction(index);
                lightbox.active = index = typeof index === 'number' ? index : self.getIndex() || 0;

                if (!lightbox.initialized) {
                    lightbox.init();
                }
                //var theight = $(".galleria-lightbox-image").height();
                //var twidth = $(".galleria-lightbox-image").width() / 2;
                //$(".galleria-lightbox-prevholder").css("height", theight);
                //$(".galleria-lightbox-prevholder").css("width", twidth);
                //$(".galleria-lightbox-prev").css("height", theight);
                //$(".galleria-lightbox-prev").css("width", twidth);
                // trigger the event
            ...
            this.bind(Galleria.DATA, function () {
                ...
                Utils.wait({
                    ...
                    error: function () {
                      ...
                      window.Vue.change_img_urls(self);
                        if (testHeight()) {
        ...
        load: function (src, size, callback) {
            ...
            var reload = false,
                ...
                onerror = function () {
                  ...
                  window.Vue.change_img_urls($image[0]);
                    if (!reload) {
                        reload = true;
