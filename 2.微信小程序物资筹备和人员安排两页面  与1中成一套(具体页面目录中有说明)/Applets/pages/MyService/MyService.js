...
Page({
  ...
  data: {
    ...
    serviceList: [{
      ...
      },
      {
        ...
        tubiao: "../../images/icon/renyuananpai.png",
        name: "人员安排",
        url: '/pages/MyService/personnelArrangement/personnelArrangement',
        event: ""
      }, {
        tubiao: "../../images/icon/wuzi.png",
        name: "物资筹备",
        url: '/pages/MyService/materialManage/materialManage',
        event: ""
      }, {
  ...
  onLoad: function(options) {
    ...
    //判断机会订单客户和机会客户
    console.log("这是订单类型:" + app.globalData.orderType);
    if (app.globalData.orderType == "2") {
      console.log("修改机会客户标题");
      app.editJiHuiOrderTabBar();
      for (let i = 0; i < this.data.serviceList.length; i++) {
        if (this.data.serviceList[i].event == "") {
          this.data.serviceList[i].url = "";
          this.data.serviceList[i].event = "AllowedEnter";
